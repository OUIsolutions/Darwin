...
darwin.generate_c_executable_output({private_darwin.OPEN} filename = "{private_darwin.project_name}.c" {private_darwin.CLOSE})
darwin.generate_lua_output({private_darwin.OPEN} filename = "{private_darwin.project_name}.lua" {private_darwin.CLOSE})
