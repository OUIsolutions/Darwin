...
Addluafile("src/extra.lua")
Addluafile("src/globals.lua")
Addluafile("src/modules.lua")
Addluafile("src/embed/embed.lua")
Addluafile("src/cinterop/basic.lua")
Addluafile("src/cinterop/cfile.lua")
Addluafile("src/embed/luaembed.lua")
Addluafile("src/embed/cembed.lua")
Addluafile("src/generators/mainc_generator.lua")
Addluafile("src/generators/lua_generator.lua")
Addluafile("src/main.lua")
