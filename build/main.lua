...
local function main()
    ...
    Create_api_assets()
    Embed_types()
    darwin.add_lua_code("local private_darwin_stellar_modulue = function()\n")
    darwin.add_lua_file("dependencies/stellar.lua")
    darwin.add_lua_code("\nend")
    darwin.add_lua_code("private_darwin_stellar_modulue = private_darwin_stellar_modulue()\n")
